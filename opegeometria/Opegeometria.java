...
System.out.print("\n-----------------------------------------------------------------------------------------");
		...
		resultadoArea = rectangulo.area(altura,base);

		System.out.println("\nEl AREA del RECTANGULO es: " + resultadoArea);

		resultadoPerimetro = rectangulo.perimetro(altura,base);
...
System.out.print("\n***********************************************************************************");
		...
		resultadoArea = circulo.area(radio);

		System.out.println("\nEl AREA del circulo es: " + resultadoArea);

		resultadoCircunferencia = circulo.circunferencia(radio);
